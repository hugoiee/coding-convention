...
```shell
$ npm install iee-eslint-plugin eslint --save-dev
```
...
// .eslintrc.js
module.exports = {
  plugin: ['iee-eslint-config'],
  rules: {
    'iee-eslint-config/no-secret-info': 'error',
  },
};
```
...
// .eslintrc.js
module.exports = {
  extends: 'plugin:eiee-eslint-config/recommended',
};
```
